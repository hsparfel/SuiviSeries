...
public class SerieDao extends AbstractDao<Serie, Long> {
    ...
    public static final String TABLENAME = "SERIE";
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SERIE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Serie entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Serie entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(Serie entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(Serie entity) {
