...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        ContactIgnoreDao.createTable(db, ifNotExists);
        DepartementDao.createTable(db, ifNotExists);
        EtablissementDao.createTable(db, ifNotExists);
        ImportContactDao.createTable(db, ifNotExists);
        ImportEtablissementDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        ContactIgnoreDao.dropTable(db, ifExists);
        DepartementDao.dropTable(db, ifExists);
        EtablissementDao.dropTable(db, ifExists);
        ImportContactDao.dropTable(db, ifExists);
        ImportEtablissementDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(ContactIgnoreDao.class);
        registerDaoClass(DepartementDao.class);
        registerDaoClass(EtablissementDao.class);
        registerDaoClass(ImportContactDao.class);
        registerDaoClass(ImportEtablissementDao.class);
